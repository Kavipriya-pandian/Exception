...
public class Exception_Assignment1_JumboBusService 
{
...
//1
		BusBooking booking1= new BusBooking(101,"Toronto", "Regular");
		String result1 = booking1.bookTrip("BIGBUS", 11);
		if(result1.equals("Booking successful"))
		{
		...
		BusBooking booking2 = new BusBooking(101,"Orlando", "Exclusive");
		String result2 = booking2.bookTrip("BIGBUS", 11);
		if(result2.equals("Booking successful"))
		{
		...
		BusBooking booking3 = new BusBooking(101,"Orlando", "Regular");
		String result3 = booking3.bookTrip("BIGBUS", 8);
		if(result.equals("Booking successful"))
		{
